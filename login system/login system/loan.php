...
<body class="bg-image1">
  ...
  <ul class="dropdown-menu bg-dark ">
    <li><a class="text-light m-2" href="loan.php?type=home">Home Loan</a></li>
    <li><a class="text-light m-2" href="loan.php?type=education">Education Loan</a></li>
...
if(isset($_GET['type'])) {
  ...
  switch($type) {
    case 'home':
      include 'home_loan.php';
      break;
    case 'education':
      include 'education_loan.php';
      break;
    case 'personal':
      include 'personal_loan.php';
      break;
    case 'fd':
      include 'fd.php';
      break;
