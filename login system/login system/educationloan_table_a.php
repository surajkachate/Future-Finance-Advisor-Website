...
<body >
    ...
    <div class="bg-image">
        <h1 class="text-center text-danger mb-3 mx-3"><b>EDUCATION LOAN PREFERENCE</b></h1>
...
$bankData = array(
    "HDFC" => array(	8.00,	8.25,	8.50,	10.25,	11.00),
    "AXIS" => array(	8.50,	8.50,	9.00,	10.00,	10.75),
    "ICICI" => array(	8.75,	9.00,	9.25,	10.25,	11.25),
    "BANK OF INDIA" => array(	9.00,	9.25,	9.50,	10.25,	11.50),
    "BANK OF BARODA" => array(	8.25,	8.25,	9.00,	9.75,	11.00),
    "KOTAK" => array(	8.00,	9.00,	9.50,	10.25,	11.25),
    "CANERA" => array(	7.50,	8.25,	8.50,	9.25,	10.00),
    "SBI" => array(	8.00,	8.75,	9.00,	10.25,	11.00),
    "PUNB" => array(	8.25,	8.75,	9.25,	10.25,	11.25),
    "UNION" => array(	8.25,	9.00,	9.50,	10.50,	11.25)
