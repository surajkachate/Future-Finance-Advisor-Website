...
<body class="bg-image1">
  ...
  <ul class="dropdown-menu bg-dark ">
    <li><a class="text-light m-2" href="fd_a.php?type=adult">FD - ADULT</a></li>
    <li><a class="text-light m-2" href="fd_a.php?type=senior">FD - SENIOR</a></li>
...
if(isset($_GET['type'])) {
  ...
  switch($type) {
    case 'adult':
      include 'fd_adult_a.php';
      break;
    case 'senior':
      include 'fd_senior_a.php';
      break;
    default:
